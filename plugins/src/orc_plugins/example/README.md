...
Reference plugin exercising every `orc_plugins` pattern. Logic bodies are stubs
...
```
plugin Example orc_plugins.example
```
...
```
# example.orc
setting foo_backend  orc_plugins.example.dal.foo.acme
