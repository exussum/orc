...
setting audio_device    'NO_AUDIO_DEVICE_IN_TESTS'
...
plugin 'Pair LG TV'       orc_plugins.lgtv            --function plugins.pair_tv     --section device --backend orc_plugins.lgtv.dal.tv.stub
