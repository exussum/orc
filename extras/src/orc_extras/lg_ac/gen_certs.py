...
def _key_usage(*, key_encipherment: bool = False, key_cert_sign: bool = False, crl_sign: bool = False) -> x509.KeyUsage:
...
def _server(
    ...
    cert = (
        ...
        .add_extension(_key_usage(key_encipherment=True), critical=True)
        .add_extension(
